 ...
 */
type encodeParameter = (type: string, param: object) => string
 ...
 */
type encodeContractDeploy = (jsonInterface, bytecode, ...args) => string
 ...
 */
type encodeFunctionCall = (jsonInterface: Array<any>, params: Array<any>) => string
 ...
 * @return {String} encoded plain param
 */
const encodeParameter: (type: string, param: object) => string
 ...
 * @return {String} bytecode + args
 */
const encodeContractDeploy: (jsonInterface, bytecode, ...args) => string
 ...
 * @return {String} The encoded ABI for this function call
 */
const encodeFunctionCall: (jsonInterface: Array<any>, params: Array<any>) => string
